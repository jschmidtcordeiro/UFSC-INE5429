...
\titulo{\lang{Ethical Analysis in Information Security}{Análise Ética em Segurança da Informação}}
...
\begin{document}
    ...
    \chapter{Introdução}
    \input{chapters/00-introducao.tex}
    
    \chapter{Responsabilidade Social e Profissional}
    \input{chapters/01-responsabilidade.tex}
    
    \chapter{Princípios Éticos da ACM}
    \input{chapters/02-principios-acm.tex}
    
    \chapter{Impactos Éticos das Falhas de Segurança}
    \input{chapters/03-impactos.tex}
    
    \chapter{Dimensões Éticas do Gerenciamento de Riscos}
    \input{chapters/04-gerenciamento-riscos.tex}
    
    \chapter{Conclusão}
    \input{chapters/05-conclusao.tex}

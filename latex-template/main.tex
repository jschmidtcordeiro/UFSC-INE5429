...
\begin{document}
    ...
    % Exemplo de conteúdo básico - substitua pelo seu conteúdo
    \chapter{Introdução}
    Este capítulo introduz o tema do trabalho, apresentando o problema, os objetivos, a justificativa e a estrutura do documento.
    
    \section{Contextualização}
    Descreva aqui o contexto em que o trabalho está inserido.
    
    \section{Problema}
    Apresente o problema que será abordado no trabalho.
    ...
    Liste os objetivos específicos do trabalho.
    
    \section{Justificativa}
    Explique a importância do trabalho e por que ele é relevante.
    
    \section{Estrutura do Documento}
    Descreva como o documento está organizado.
